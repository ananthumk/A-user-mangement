    ...
    <div className='fixed top-0 left-0 z-10 w-full flex justify-center items-center min-h-[100vh] bg-[rgba(0,0,0,0.5)]'>
      <div className='w-[95%] md:w-auto py-4 md:py-6 px-3 md:px-5 bg-white shadow-lg shadow-white rounded-md'>
         ...
         <form onSubmit={handleSubmit} className='flex flex-col gap-3'>
            <div className='flex flex-col md:flex-row gap-3 max-w-2xl items-start md:items-center justify-between'>
                <div className='w-full'>
                    <label className='text-sm md:text-md mb-2 font-semibold' >First Name</label>
                ...
                <div className='w-full'>
                    <label className='text-sm md:text-md mb-2 font-semibold'>Last Name</label>
            ...
            <div>
                ...
                <div className='grid self-end grid-cols-2 gap-2'>
                    <button onClick={() => setShowAddUser(false)} 
                      className='rounded border-2 w-full md:w-[120px] py-1 md:py-2 bg-white border-gray-200 text-sm md:text-lg font-medium text-black cursor-pointer'>
                      Cancel
                    </button>
